...
scan = '../../../torsion_scan/MP2_torsion_scan/'
# Print initial guess
...
model = Model.TorsionFitModelEliminatePhase(param, optimized_0, platform=platform,
                                            param_to_opt=param_to_opt, decouple_n=True, sample_n5=False)
sampler = MCMC(model.pymc_parameters, db=sqlite_plus, dbname='butane_all_decouple_n_10000.db', verbose=5)
